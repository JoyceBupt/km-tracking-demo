...
> **在线体验**：<https://km-tracking-demo.vercel.app/>（部署在 Vercel）
>
> 配套实验报告见仓库外的 `课程作业报告.md`。
...
| Tab | 内容 |
|---|---|
| **匹配** | 矩阵编辑器、三算法结果对比、KM 最优匹配的二部图、KM 分步执行回放 |
...
- 选用问题：多目标跟踪中的数据关联（结合 WebAR / 语义分割研究方向）
